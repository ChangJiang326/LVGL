...
//1��Һ���ӿ�����
//#define SPI//SPI�ӿ�
//#define P_8BIT//8λ���ڣ���IOģ�����
#define FSMC_16BIT//16λ���߽ӿڣ����ó�FSMC


//2��Һ������������,����ѡ������ѯҵ��Ա������ʱ�����ã����߲鿴Һ��PCB����Ĵ洢��оƬ��
#define NOR_FLASH//�洢оƬ�ͺţ�w25q64����w25q128
//#define  NAND_FLASH//�洢оƬ�ͺţ�w25n01


//3�����ô�����

//#define RTP//������
#define CTP_GT//GTоƬ�ĵ�����
//#define CTP_FT//FTоƬ�ĵ�����
//#define Touch_NC//����������
...
#endif
//8λ����io����
#define RDATA      GPIOB->IDR//GPIOB������
#define DATA_BUS       GPIOB->ODR//����GPIOB�Ķ˿����üĴ������˿�������ݼĴ���(GPIOB_ODR)��
...
#define rs1   GPIOF->BSRR = GPIO_PIN_0
#define rs0   GPIOF->BRR = GPIO_PIN_0
...
#define  Layer0	       2181120+0*lcdx*lcdy*2
#define  Layer1	       2181120+1*lcdx*lcdy*2
#define  Layer2	       2181120+2*lcdx*lcdy*2
#define  Layer3	       2181120+3*lcdx*lcdy*2
#define  Layer4	       2181120+4*lcdx*lcdy*2											  													  
...
void FLASH_Read_1024GMb_1(unsigned char *pBuffer, unsigned int ReadAddr, unsigned short NumByteToRead);
